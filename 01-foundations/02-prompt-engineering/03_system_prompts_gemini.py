"""
System Prompts & Role Engineering (Gemini)
...
class PromptEngineer:
    ...
    def run(self, system_prompt: str, user_prompt: str) -> str:
        ...
        # Gemini uses GenerateContentConfig to pass system instructions and model parameters
...
def main() -> None:
    ...
    # gemini-2.5-flash is the standard lightweight model comparable to gpt-4o-mini / claude-3-5-haiku
    engineer = PromptEngineer("gemini-2.5-flash", token_tracker)
