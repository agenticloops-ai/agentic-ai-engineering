...
class FewShotClient:
    ...
    def _call(self, instructions: str, user_input: str) -> str:
        ...
        # OpenAI uses 'instructions' for system-level prompts
    ...
    def classify_zero_shot(self, request: str) -> str:
        ...
        return self._call(instructions, request).strip()
    ...
    def classify_few_shot(self, request: str) -> str:
        ...
        return self._call(instructions, f'Request: "{request}"\nCategory:').strip()
    ...
    def classify_few_shot_cot(self, request: str) -> str:
        ...
        return self._call(instructions, f'Request: "{request}"').strip()
...
def main() -> None:
    ...
    client = FewShotClient("gpt-4o", token_tracker)
