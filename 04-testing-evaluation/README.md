...
| 2 | [Evals](02-evals/) | + golden datasets, LLM-as-judge, scoring rubrics |
...
| 🏆 | [Eval Harness](06-eval-harness/) | Combines all 5 techniques into a full pipeline |

## 💡 Tips for Success

1. **Start with unit tests** — they're fast, free, and catch most bugs in agent scaffolding
2. **Build golden datasets early** — curate 15-20 representative tasks before optimizing
...
- Detect regressions across evaluation runs
...
### 🏆 [06 - Eval Harness](06-eval-harness/)

**What you'll learn:**
- Combine all 5 testing techniques into a unified pipeline
